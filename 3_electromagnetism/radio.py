...
try:
    while True:
        ...
        if n % 5 == 0:
            ...
            ax.imshow(B_z.T, origin="lower", extent=ext, aspect="equal",
                      cmap="RdBu_r", vmin=-v, vmax=v)      # pole: cervena/modra
            ax.imshow(np.transpose(rgba, (1, 0, 2)), origin="lower",
                      extent=ext, aspect="equal")          # vodic navrch
            ...
            ax.imshow(np.transpose(bulb, (1, 0, 2)), origin="lower",
